...
module.exports = class ListItem extends EditableListItem
  ...
  getTemplateData: ->
    ...
    td.facebookConnectUrl = "https://www.facebook.com/dialog/oauth?client_id=#{window.facebookClientId}&scope=publish_actions,user_events,manage_pages,publish_stream,file_upload,photo_upload,create_event&redirect_uri=#{encodeURIComponent(callbackUrl)}"
