...
if(document.addEventListener ){ 
   ...
   aLoader = [
    { load: "/client/edge/edge.2.0.1.min.js"},
          { load: "/client/edge/HOOPLADOTS_edge.js"},
          { load: "/client/edge/HOOPLADOTS_edgeActions.js"}];
...
dlContent={
   dom: [
   {
      id:'Hoopla3Dots_IE8_Fallback',
      type:'image',
      tag:'img',
      rect:['242px','154px','80px','70px','auto','auto'],
      fill:["rgba(0,0,0,0)",'/client/images/Hoopla3Dots_IE8_Fallback.gif','0px','0px']
   }]};//simpleContent
